...
CREATE TABLE STUDENTS_QUIZ(
  ...
  quiz_fkid INT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (student_fkid) REFERENCES STUDENTS (student_id) ON DELETE CASCADE,
  FOREIGN KEY (quiz_fkid) REFERENCES QUIZ (id) ON DELETE CASCADE
);
...
CREATE TABLE STUDENTS_ANSWERS(
  ...
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (student_fkid) REFERENCES STUDENTS (student_id) ON DELETE CASCADE,
  FOREIGN KEY (answer_fkid) REFERENCES ANSWERS (id) ON DELETE CASCADE 
);
